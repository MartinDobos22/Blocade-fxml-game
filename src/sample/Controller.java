...
import static sample.Body.draw;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        private void resetRound(Player p){
            if(p.getName().equals("Player")) {
                ...
                player.setScore(enemy.getScore() + 1);
            }
            canShowScore = true;
            round.stop();
            Body.reset();
        ...
        private void showScore(){
            if(canShowScore){
                ...
                graphicsContext.fillText(String.valueOf(player.getScore()), canvas.getWidth() / 2 - 100, 50, 100);
                graphicsContext.fillText(String.valueOf(enemy.getScore()), canvas.getWidth() / 2 + 100, 50, 100);
            }
        }
